...
@Autonomous(name = "AutoFoundationBlueBridge", group = "Linear Opmode")

//@Disabled
public class AutoFoundationBlueBridge extends LinearOpMode
{
  ...
  public void runOpMode() {
    ...
    LatchPt3.add(new Leg(Leg.Mode.FORWARD,50, 0,1.25));
